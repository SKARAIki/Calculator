...
public class App {
    public static void main(String[] args) {
       ...
       {System.out.print("사칙연산 기호을 입력하세요: ");
        ...
        String add2 = String.valueOf(operator); // 문자를 문자열로 변환
      ...
      //.next와 nextline의 차이점 - 앞에서 쓰인 개행문자를 가져오냐 안가져오냐
     //. nextline을 하나 더 앞에 써 놓아, 입력이 스킵되는 것을 방지하는 것 보다 .next가 더 가독성 있는것 같아 .next사용 하였습니다
